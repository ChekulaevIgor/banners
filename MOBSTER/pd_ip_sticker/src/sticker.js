...
(lib.confetti = function() {
	this.initialize(img.confetti);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,450,692);
...
p.nominalBounds = new cjs.Rectangle(0,0,249,75);


(lib.txt2 = function() {
	this.initialize(img.txt2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,223,80);// helper functions:
...
}).prototype = getMCSymbolPrototype(lib.Символ16, new cjs.Rectangle(-88,-143,176,286), null);
...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-124.5,-37.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ15, new cjs.Rectangle(-124.5,-37.5,249,75), null);
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-111.5,-40);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ14, new cjs.Rectangle(-111.5,-40,223,80), null);
...
(lib.Символ11 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-569,369.5,1.643,1.643,-90);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ11, new cjs.Rectangle(-569,-370,1137.2,739.5), null);
...
p.nominalBounds = new cjs.Rectangle(-88,-143,176,286);
...
p.nominalBounds = new cjs.Rectangle(-124.5,-40,249,80);
...
(lib.Символ12 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.04,scaleY:1.04},24,cjs.Ease.get(-1)).to({scaleX:1.08,scaleY:1.08},25,cjs.Ease.get(1)).to({scaleX:1.04,scaleY:1.04},25,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1},25,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-569,-370,1137.2,739.5);
...
}).prototype = getMCSymbolPrototype(lib.Символ4, new cjs.Rectangle(-568.2,-370,1137.2,739.5), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ3, new cjs.Rectangle(-88,-143,176,286), null);
...
}).prototype = getMCSymbolPrototype(lib.Символ1, new cjs.Rectangle(-124.5,-40,249,80), null);
...
(lib.sticker = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		window._setCanvasSize = function(){
			...
			var s = _MBSTR.windowSize(), 
				...
				w = bw = s.iw, h = bh = s.ih, sh = s.sh,
				stage_scale = _MBSTR.windowScale(),
				cs = function(size){ return size * stage_scale},
				
				_port = w < sh, _land = w > sh,
				_mob = w < sh && w < cs(420) && sh < cs(750) || w > sh && sh < cs(420) && w < cs(750);
			...
			var EL = {
				logo : {
					x : _mob && _port || !_mob && _port ? bw * 0.5 : bw * 0.83,
					y : _mob && _port || !_mob && _port ? bh * 0.15 : bh * 0.3,
					s : _mob ? 1.5 : 1.2,
				},
				
				btn : {
					x : _mob && _port || !_mob && _port ? bw * 0.5 : bw * 0.83,
					y : _mob && _port || !_mob && _port ? bh * 0.8 : bh * 0.7,
					s : _mob ? 1.7 : 1.3,
				},
				
				conf : {
					x : _mob && _port || !_mob && _port ? bw / 2 : bw * 0.5,
					y : _mob && _port || !_mob && _port ? bh * 0.5 : bh / 2,
					s : 1,
				},
				
				txt1 : {
					x : _mob && _port || !_mob && _port ? bw * 0.5 : bw * 0.45,
					y : _mob && _port || !_mob && _port ? bh * 0.45 : bh * 0.5,
					s : _mob ? _land ? 2.1 : 1.8 : _land ? 1.7 : 1.3,
				},
				
				cards : {
					x : _mob && _port || !_mob && _port ? bw * 0.12 : bw * 0.08,
					y : _mob && _port || !_mob && _port ? bh * 1.2 : bh * 1.2,
					s : 1.2,
				},
				...
				iphone : {
					x : _mob && _port || !_mob && _port ? bw * 0.88 : bw * 0.15,
					y : _mob && _port || !_mob && _port ? bh * 1.2 : bh * 1.2,
					s : 1.5,
				}
			};
	...
	// confetti.png
	this.conf = new lib.Символ4();
	this.conf.parent = this;
	this.conf.setTransform(483,346);

	this.timeline.addTween(cjs.Tween.get(this.conf).wait(1));
...
p.nominalBounds = new cjs.Rectangle(397.3,190,1137.2,780.5);
// library properties:
lib.properties = {
	width: 965,
	height: 510,
	...
	manifest: [
		...
		{src:"images/confetti.png", id:"confetti"},
