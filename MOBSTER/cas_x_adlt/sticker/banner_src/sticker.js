...
p.nominalBounds = new cjs.Rectangle(0,0,135,563);// helper functions:
...
(lib.Символ13 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:29.9,y:120.6},5,cjs.Ease.get(-1)).to({x:4,y:119.5},5,cjs.Ease.get(1)).to({x:29,y:120.5},5,cjs.Ease.get(-1)).to({x:54,y:121.5},5,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:-2,x:6,y:-177},5,cjs.Ease.get(-1)).to({rotation:-4.5,x:-20.9,y:-175.5},5,cjs.Ease.get(1)).to({regY:-0.1,rotation:-2.1,x:5.1,y:-177},5,cjs.Ease.get(-1)).to({regY:0,rotation:0,x:31,y:-178.5},5,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({rotation:-0.5,x:247.7,y:-31.9},5,cjs.Ease.get(-1)).to({regX:242.3,rotation:-1.2,x:221.8,y:-33},5,cjs.Ease.get(1)).to({rotation:-0.5,x:246.8,y:-32},5,cjs.Ease.get(-1)).to({regX:242.2,rotation:0,x:271.7,y:-31},5,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({rotation:4.3},5,cjs.Ease.get(-1)).to({regX:-67.2,regY:-33.9,rotation:9,x:-196.2,y:-240.4},5,cjs.Ease.get(1)).to({rotation:4.3,x:-196.1,y:-240.3},5,cjs.Ease.get(-1)).to({regX:-67.1,regY:-33.8,rotation:0},5,cjs.Ease.get(1)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:-91.7,y:-193.4},5,cjs.Ease.get(-1)).to({x:-116,y:-197},5,cjs.Ease.get(1)).to({x:-92.5,y:-193.5},5,cjs.Ease.get(-1)).to({x:-69,y:-190},5,cjs.Ease.get(1)).wait(1));
...
(lib.sticker = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		var _this = this;
			...
			var /* Размер баннера */
				...
				minWidth = w < h ? ((w > 599) ? 1500 : 700) : ((w > 950) ? ((w > 1300) ? 1700 : 1500) : 900),
				minHeight = 300,
			...
			_this.btn1.x = w < h ? iw * 0.7 : iw * 0.48;
		    _this.btn1.y = w < h ? ih * 0.3 : ih * 0.5;
		    
			_this.btn2.x = w < h ? iw * 0.7 : iw * 0.78; 
		    _this.btn2.y = w < h ? ih * 0.7 : ih * 0.5;
			
			_this.bj.x = w < 481 ? iw * (-0.03) : 0;
		    _this.bj.y = w < h ? ((w > 599) ? ih * 1.1 : ((w < 321) ? ih * 1.25 : ih)) : ((w > 959) ? w > 1020 ? ih * 1.6 : ih * 1.4 : ih * 1.5);
			/* Функция ресайза */
		    function setScale(scale) {
				
				_this.btn1.scaleX = _this.btn1.scaleY = w > h ? ((w > 1020) ? scale * 0.9 : ((w < 481) ? scale * 1.45 : scale * 1.2)) : ((w < 321) ? scale * 1.1 : scale);
				_this.btn2.scaleX = _this.btn2.scaleY = w > h ? ((w > 1020) ? scale * 0.9 : ((w < 481) ? scale * 1.45 : scale * 1.2)) : ((w < 321) ? scale * 1.1 : scale)
				_this.bj.scaleX = _this.bj.scaleY = w < 569 && h < 321 || w < 321 && h < 569 ? scale * 1.17 : w < 415 && w > 321 ? scale * 0.8 : scale;
		    }
	...
	this.bj.parent = this;
	this.bj.setTransform(169.9,818.7,1,1,0,0,0,-377.6,438.2);
...
p.nominalBounds = new cjs.Rectangle(668.4,391.7,1260.6,898.2);
// library properties:
lib.properties = {
	width: 1024,
	height: 768,
