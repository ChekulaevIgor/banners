...
(lib.fullscreen = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		window._setCanvasSize = function() {
			...
			_this.bj.x = 0;
		    _this.bj.y = w < h ? ((w < 385) ? ((w < 321) ? ih * 1.33 : ih * 1.47) : ((w > 767) ? ih * 1.45 : ih * 1.3)) : ((w < 641) ? ih * 1.6 : ((w < 737) ? ih * 1.45 : ih * 1.16));
			/* Функция ресайза */
		    function setScale(scale) {
				...
				_this.bj.scaleX = _this.bj.scaleY = w < h ? ((w < 385) ? scale * 2.3 : ((w > 767) ? scale * 1.8 : ((w > 599) ? scale * 2.1 : scale * 1.8))) : ((w < 641) ? scale * 1.6 : scale * 1.2);
		    }
