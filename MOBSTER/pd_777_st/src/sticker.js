...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-141,-12,1.26,1.26);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ14, new cjs.Rectangle(-141,-12,281,29), null);
...
p.nominalBounds = new cjs.Rectangle(-141,-15.5,281,32.5);
...
}).prototype = getMCSymbolPrototype(lib.Символ1, new cjs.Rectangle(-141,-15.5,281,32.5), null);
...
(lib.sticker = function(mode,startPosition,loop) {
		...
		window._setCanvasSize = function(){
			...
			var EL = {
				...
				txt1 : {
					...
					s : _mob ? _land ? 2.1 : 2.3 : _land ? 1.7 : 1.3,
				},
	...
	this.btn.setTransform(373.2,298.9);
	...
	this.txt1.setTransform(372.2,18.4);
	...
	this.logo.setTransform(373.2,298.9);
	...
	this.iphone.setTransform(372.7,367.4,1,1,0,0,0,0,143);
	...
	this.cards.setTransform(373.2,414.4,1,1,0,0,0,0,115.5);
	...
	this.chip3.setTransform(497.7,444.9);

	this.timeline.addTween(cjs.Tween.get(this.chip3).wait(1));

	// chip4
	this.chip4 = new lib.Символ22();
	this.chip4.parent = this;
	this.chip4.setTransform(763.7,332.9);

	this.timeline.addTween(cjs.Tween.get(this.chip4).wait(1));

	// chip2
	this.chip2 = new lib.Символ21();
	this.chip2.parent = this;
	this.chip2.setTransform(660.7,173.9);

	this.timeline.addTween(cjs.Tween.get(this.chip2).wait(1));

	// chip1
	this.chip1 = new lib.Символ5();
	this.chip1.parent = this;
	this.chip1.setTransform(204.7,133.4,1,1,0,0,0,-4,-5.5);

	this.timeline.addTween(cjs.Tween.get(this.chip1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(637.2,257.9,663,510.5);
// library properties:
lib.properties = {
	width: 965,
	height: 510,
