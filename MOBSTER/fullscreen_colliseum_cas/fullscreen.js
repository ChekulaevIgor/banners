...
p.nominalBounds = new cjs.Rectangle(0,0,297,47);


(lib.txt2 = function() {
	this.initialize(img.txt2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,287,31);


(lib.txt3 = function() {
	this.initialize(img.txt3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,299,39);// helper functions:
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-143,-19);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ48, new cjs.Rectangle(-143,-19,287,31), null);
...
(lib.Символ47 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-148,-19);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ47, new cjs.Rectangle(-148,-19,299,39), null);
...
(lib.Символ10 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-149,-29);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ10, new cjs.Rectangle(-149,-29,297,47), null);
...
p.nominalBounds = new cjs.Rectangle(-283.8,-54.2,565.7,89.6);
...
}).prototype = getMCSymbolPrototype(lib.Символ2, new cjs.Rectangle(-252.3,-52.3,504.4,79.8), null);
...
(lib.fullscreen = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		window._setCanvasSize = function() {
		    ...
		    var /* Размер баннера */
				...
				minWidth = w < 321 ? 360 : ((w > h && w > 1020) ? 1200 : 450),
				minHeight = 550,
		    ...
		    _this.btn.x = w < h ? iw * 0.5 : iw * 0.75;
		    _this.btn.y = w < h ? ih * 0.9 : ih * 0.77;
			
			_this.slot.x = w < h ? iw * 0.5 : iw * 0.27;
		    _this.slot.y = w < h ? ih * 0.52 : ih * 0.5;
			
			_this.txt.x = w < h ? iw * 0.5 : iw * 0.75;
		    _this.txt.y = w < h ? ih * 0.18 : ih * 0.5; 
			
			_this.logo.x = w < h ? iw * 0.5 : iw * 0.75;
		    _this.logo.y = w < h ? ih * 0.07 : ih * 0.24;
			
		    
			/* Функция ресайза */
		    function setScale(scale) {
				
		        _this.btn.scaleX = _this.btn.scaleY = w < h ? scale * 0.8 : w > h && w < 481 ? scale * 0.95 : ((w > 959) ? scale * 0.8 : scale * 1.1);
				_this.slot.scaleX = _this.slot.scaleY = w < h ? scale : scale * 1.35;
				_this.txt.scaleX = _this.txt.scaleY = w < h ? scale * 0.8 : w > h && w < 481 ? scale * 0.95 : scale * 1.1;
				_this.logo.scaleX = _this.logo.scaleY = w < h ? scale : ((w > 959) ? scale * 1.5 : scale * 2);
		    }
	...
	this.slot.setTransform(823.9,303.2,1,1,0,0,0,0,0.4);
