...
(lib.Символ11 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-565.7,-870,2.514,2.514);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ11, new cjs.Rectangle(-565.7,-870,1131.5,1740), null);
...
p.nominalBounds = new cjs.Rectangle(-565.7,-870,1131.5,1740);
...
}).prototype = getMCSymbolPrototype(lib.Символ4, new cjs.Rectangle(-565,-870,1131.5,1740), null);
		...
		window._setCanvasSize = function(){
			...
			var EL = {
				logo : {
					...
					y : _mob && _port || !_mob && _port ? bw * 0.15 : bw * 0.1,
					s : 1
				},
				...
				chip1 : {
					...
					y : _mob && _port || !_mob && _port ? bh * 0.5 : 0,
					s : 1.2,
				},
...
p.nominalBounds = new cjs.Rectangle(400.5,-269,1131.5,1740);
// library properties:
lib.properties = {
	width: 965,
	height: 510,
