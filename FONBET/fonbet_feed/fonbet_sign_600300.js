...
p.nominalBounds = new cjs.Rectangle(0,0,1274,136);
...
(lib.Символ2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-322,-161,1.073,1.073);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ2, new cjs.Rectangle(-322,-161,644,322), null);
...
}).prototype = getMCSymbolPrototype(lib.team_bg, new cjs.Rectangle(0,0.1,285.6,41), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol5, new cjs.Rectangle(0,0,787.2,461.6), null);
...
(lib.Символ43 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:894.5,y:-894.4},59).wait(1));
...
(lib.Символ41 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:1241.5,y:-1241.5},69).wait(1));
...
(lib.Символ39 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:1340.7,y:-1340.7},84).wait(1));
...
(lib.Символ37 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:1307.7,y:-1307.7},61).wait(1));
...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(70,17.7);
	...
	this.instance.parent = this;
	this.instance.setTransform(68.2,18.8);
	this.instance.filters = [new cjs.BlurFilter(40, 40, 1)];
	this.instance.cache(-67,-19,135,38);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ18, new cjs.Rectangle(-17.4,-18.4,175,77), null);
...
(lib.Символ1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.18},14,cjs.Ease.get(1)).to({alpha:0},15,cjs.Ease.get(1)).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-322,-161,644,322);
...
}).prototype = getMCSymbolPrototype(lib.team_2, new cjs.Rectangle(0.4,0.1,285.6,219.7), null);
...
}).prototype = getMCSymbolPrototype(lib.team_1, new cjs.Rectangle(0,0.1,285.6,219.7), null);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-80,265,0.614,0.614);
	this.instance.alpha = 0.32;
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(301,151);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1.05,scaleY:1.05},24,cjs.Ease.get(-1)).to({scaleX:1.1,scaleY:1.1},25,cjs.Ease.get(1)).to({scaleX:1.05,scaleY:1.05},25,cjs.Ease.get(-1)).to({scaleX:1,scaleY:1},25,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-580.7,-10,1203.8,809.5);
...
(lib.bg_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:300.1,regY:150.1,scaleX:0.94,scaleY:0.94,x:300.1,y:150.1},9,cjs.Ease.get(1)).to({regX:300,regY:150,scaleX:1,scaleY:1,x:300,y:150},10,cjs.Ease.get(-1)).wait(1));
...
// stage content:
(lib.fonbet_sign_600300 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		var flags = {
			...
			'гаити' : 'haiti.png',
			'гватемала' : 'guatemala.png',
			'гондурас' : 'honduras.png',
			'доминиканская республика' : 'dominicana.png',
			'колумбия' : 'columbia.png',
			'коста-рика' : 'costarica.png',
			'куба' : 'cuba.png',
			'мексика' : 'mexico.png',
			'никарагуа' : 'nicaragua.png',
			'панама' : 'panama.png',
			'парагвай' : 'paraguay.png',
			'перу' : 'peru.png',
			'сальвадор' : 'salvador.png',
			'уругвай' : 'uruguay.png',
			'чили' : 'chile.png',
			'эквадор' : 'ecuador.png',
		};
		...
		function getFlag(country) {
			...
			if (flags[key] !== undefined) {
				...
				return 'https://psma01.com/media/signs_fonbet/' + flags[key];
			}
			else {
		    return 'https://psma01.com/media/signs_fonbet/ball.png';
		   }
		...
		function createRequest() {
			...
			script.src = "https://root-srv.gameclub.xyz/BetsService/line/news/all/ru?callback=fonbet_callback&" + Math.random();
	...
	this.btn.setTransform(300.7,201,1,1,0,0,0,96.6,28.2);
...
p.nominalBounds = new cjs.Rectangle(-280.7,69.2,1466,880.3);
// library properties:
lib.properties = {
	width: 600,
	height: 300,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1504604104332", id:"bg"},
		{src:"images/light.png?1504604104332", id:"light"},
		{src:"images/logo.png?1504604104332", id:"logo"},
		{src:"images/orang.jpg?1504604104332", id:"orang"},
		{src:"images/zagl_1.png?1504604104332", id:"zagl_1"},
		{src:"images/zagl_2.png?1504604104332", id:"zagl_2"}
	],
	preloads: []
};
