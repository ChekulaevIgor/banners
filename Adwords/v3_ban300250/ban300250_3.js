...
(lib.Символ38 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f().s("#87BD45").ss(1,1,1).p("A3bzhMAu3AAAMAAAAnDMgu3AAAg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ38, new cjs.Rectangle(-151,-126,302,252), null);
...
(lib.Символ37 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text(txt8, txt8style, "#FFFFFF");
...
(lib.Символ32 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text(txt7, txt7style, "#87BB45");
	this.text.textAlign = "center";
...
(lib.Символ31 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text(txt6, txt6style, "#545454");
	this.text.lineHeight = 19;
...
(lib.Символ30 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text(txt5, txt5style, "#545454");
...
(lib.Символ28 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text(txt4, txt4style, "#FFFFFF");
	this.text.textAlign = "center";
...
(lib.Символ27 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text(txt3, txt3style, "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 33;
	this.text.lineWidth = 144;
	this.text.parent = this;
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text(txt2, txt2style, "#545454");
	this.text.lineHeight = 33;
...
(lib.Символ23 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text(txt1, txt1style, "#545454");
	this.text.textAlign = "right";
	this.text.lineHeight = 33;
	this.text.lineWidth = 105;
	this.text.parent = this;
...
(lib.Символ33 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text(txtbtn, txtbtnstyle, "#FFFFFF");
	this.text.textAlign = "center";
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/banka.png?1505823524950", id:"banka"},
		{src:"images/bg1.jpg?1505823524950", id:"bg1"},
		{src:"images/bg2.jpg?1505823524950", id:"bg2"},
		{src:"images/btn.png?1505823524950", id:"btn"},
		{src:"images/DiaVita.png?1505823524950", id:"DiaVita"},
		{src:"images/fat_wom.png?1505823524950", id:"fat_wom"},
		{src:"images/fly_banka.png?1505823524950", id:"fly_banka"},
		{src:"images/logo1.png?1505823524950", id:"logo1"},
		{src:"images/logo2.png?1505823524950", id:"logo2"},
		{src:"images/shake_banka.png?1505823524950", id:"shake_banka"},
		{src:"images/woman.png?1505823524950", id:"woman"}
	],
	preloads: []
};
