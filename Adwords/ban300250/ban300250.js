...
(lib.Символ18 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("ПОПРОБОВАТЬ", "bold 19px 'Intro Black Alt'", "#FFFFFF");
...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("ХУДЕЙ ВКУСНО!", "bold 28px 'Intro Black Alt'", "#FFFFFF");
...
(lib.Символ16 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("ЛЮБИШЬ КЕКСЫ?", "bold 23px 'Intro Black Alt'", "#FFFFFF");
...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.text = new cjs.Text("ЛЮБИШЬ ШОКОЛАД?", "bold 23px 'Intro Black Alt'", "#FFFFFF");
	this.text.lineHeight = 25;
...
(lib.Символ11 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(164).call(this.frame_164).wait(47).call(this.frame_211).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(109).to({_off:false},0).to({x:4.8,alpha:1},4).to({x:31.3},3).wait(40).to({x:4.8},3).to({x:81.3,alpha:0},5).wait(1).to({x:4.8,alpha:1},4).to({x:31.3},3).wait(40).to({x:4.8},3).to({x:81.3,alpha:0},5).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(52).to({_off:false},0).to({x:6,alpha:1},5).to({x:31},4).wait(38).to({x:6},4).to({x:71,alpha:0},5).to({_off:true},1).wait(112));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:12.8,alpha:1},5).to({x:27.8},3).wait(38).to({x:12.8},3).to({x:52.8,alpha:0},5).to({_off:true},1).wait(166));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(108).to({_off:false},0).wait(1).to({y:280},0).to({y:210,alpha:1},5,cjs.Ease.get(1)).to({y:220},2).wait(41).to({y:210},2).to({y:280,alpha:0},5).wait(1).to({y:210,alpha:1},5,cjs.Ease.get(1)).to({y:220},2).wait(41).to({y:210},2).to({y:280,alpha:0},5).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(108).to({_off:false},0).wait(1).to({x:172},0).to({x:92,alpha:1},5,cjs.Ease.get(1)).to({x:102},2).wait(41).to({x:92},2).to({x:172,alpha:0},5).wait(1).to({x:92,alpha:1},5,cjs.Ease.get(1)).to({x:102},2).wait(41).to({x:92},2).to({x:172,alpha:0},5).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(108).to({_off:false},0).wait(1).to({x:-118.5},0).to({x:-38.5,alpha:1},5,cjs.Ease.get(1)).to({x:-48.5},2).wait(41).to({x:-38.5},2).to({x:-118.5,alpha:0},5).wait(1).to({x:-38.5,alpha:1},5,cjs.Ease.get(1)).to({x:-48.5},2).wait(41).to({x:-38.5},2).to({x:-118.5,alpha:0},5).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(53).to({_off:false},0).wait(1).to({y:72},0).to({scaleY:0.89,y:132.6,alpha:1},5,cjs.Ease.get(1)).to({scaleY:1,y:122},2).wait(41).to({x:58},2).to({x:-62,alpha:0.199},4).to({x:-92,alpha:0},1).to({_off:true},1).wait(111));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(53).to({_off:false},0).wait(1).to({scaleX:1.58,scaleY:0.5,y:280.2},0).to({scaleX:0.86,scaleY:0.24,y:193.2,alpha:1},5,cjs.Ease.get(1)).to({scaleY:0.27,y:190.2},2).wait(41).to({x:58},2).to({x:-92,alpha:0},5).to({_off:true},1).wait(111));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(1).to({scaleX:1.16,scaleY:1.16,y:72.5},0).to({scaleX:1,scaleY:0.9,y:133,alpha:1},5,cjs.Ease.get(1)).to({scaleY:1,y:122.5},2).wait(38).to({x:48},3).to({x:-72,alpha:0},5).to({_off:true},1).wait(166));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({regY:0.1,scaleX:2.03,scaleY:2.03,y:232.2},0).to({regY:0,scaleX:1,scaleY:0.9,y:141.5,alpha:1},5,cjs.Ease.get(1)).to({scaleY:1,y:132},2).wait(38).to({x:48.5},3).to({x:-71.5,alpha:0},5).to({_off:true},1).wait(166));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(221));
...
(lib.ban300250 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		{
		    _this.main.gotoAndPlay(166);
		}
		stage.canvas.onmouseout = fl_MouseOutHandler_2;
		  function fl_MouseOutHandler_2()
		{
		    _this.main.gotoAndPlay(212);
		}
	}
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/banka.png?1505733997938", id:"banka"},
		{src:"images/bg.jpg?1505733997938", id:"bg"},
		{src:"images/btn.png?1505733997938", id:"btn"},
		{src:"images/choco.png?1505733997938", id:"choco"},
		{src:"images/chocoten.png?1505733997938", id:"chocoten"},
		{src:"images/circle.png?1505733997938", id:"circle"},
		{src:"images/logo.png?1505733997938", id:"logo"},
		{src:"images/muffin.png?1505733997938", id:"muffin"},
		{src:"images/muffinten.png?1505733997938", id:"muffinten"}
	],
	preloads: []
};
